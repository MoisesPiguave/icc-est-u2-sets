...
public class Ejercicios {
    ...
    public Ejercicios() {
        ...
        System.out.println("¿[1,2,3,4,5] tiene duplicados? " + tieneDuplicados(new int[]{1, 2, 3, 4, 5}));
        System.out.println("¿[1,2,3,4,5,4,3,2,45] tiene duplicados? " + tieneDuplicados(new int[]{1, 2, 3, 4, 5, 4, 3, 2, 45}));
        ...
        String texto = "La inteligencia artificial (IA) está transformando el mundo a una velocidad sin precedentes. "
                ...
                + "sino también en el impacto que genera en la humanidad y en el planeta. El futuro no está escrito, pero lo que decidamos hoy tendrá consecuencias duraderas.";

        System.out.println("Palabras únicas: " + contarPalabrasUnicas(texto));
